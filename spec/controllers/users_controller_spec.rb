...
describe UsersController do
  ...
  describe "Get 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "blah blah")
      get :show, :id => @user
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "New Name", :email => "new@example.org", :password => "barbaz", :password_confirmation => "barbaz"}
      end
      
      it "should change the user's attributes" do
        put :update, :id => @user, :user => @attr
        user = assigns(:user) # pulls out user from controller
        @user.reload
